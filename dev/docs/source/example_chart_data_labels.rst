...
Chart 4 is a chart with custom string data labels:

.. image:: _images/chart_data_labels14.png
   :scale: 75 %

Chart 5 is a chart with custom data labels referenced from worksheet cells:

.. image:: _images/chart_data_labels15.png
   :scale: 75 %

Chart 6 is a chart with a mix of custom and default labels. The ``None`` items
...
Chart 7 is a chart with some deleted custom labels and defaults (set with
