...
class TestAssembleWorksheet(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.add_sparkline({'location': 'F3',
                                 'range': 'A3:E3',
                                 'type': 'column',
                                 'negative_points': 1})

        worksheet.add_sparkline({'location': 'F4',
                                 'range': 'A4:E4',
                                 'type': 'column',
                                 'first_point': 1})

        worksheet.add_sparkline({'location': 'F5',
                                 'range': 'A5:E5',
                                 'type': 'column',
                                 'last_point': 1})

        worksheet.add_sparkline({'location': 'F6',
                                 'range': 'A6:E6',
                                 'type': 'column',
                                 'markers': 1})

        worksheet.add_sparkline({'location': 'F7',
                                 'range': 'A7:E7',
                                 'type': 'column',
                                 'high_point': 1,
                                 'low_point': 1,
