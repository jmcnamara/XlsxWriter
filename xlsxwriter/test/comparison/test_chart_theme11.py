...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        self.set_filename("chart_theme11.xlsx")
        ...
        chart.add_series(
            {
                ...
                "line": {"color": Color((9, 0))},
            }
        )
        chart.add_series(
            {
                "values": ["Sheet1", 0, 1, 7, 1],
                "line": {"color": Color((9, 1))},
            }
        )
        chart.add_series(
            {
                "values": ["Sheet1", 0, 2, 7, 2],
                "line": {"color": Color((9, 2))},
            }
        )
        chart.add_series(
            {
                "values": ["Sheet1", 0, 3, 7, 3],
                "line": {"color": Color((9, 3))},
            }
        )
        chart.add_series(
            {
                "values": ["Sheet1", 0, 4, 7, 4],
                "line": {"color": Color((9, 4))},
            }
        )
        chart.add_series(
            {
                "values": ["Sheet1", 0, 5, 7, 5],
                "line": {"color": Color((9, 5))},
            }
        )
