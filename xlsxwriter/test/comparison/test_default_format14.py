...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        self.set_filename("default_format14.xlsx")
    ...
    def test_create_file(self):
        ...
        workbook = Workbook(
            self.got_filename,
            {
                "default_format_properties": {"font_name": "Arial", "font_size": 18},
    ...
    def test_create_file_with_character_units(self):
        ...
        # Set user column width and row height to test positioning calculation.
        worksheet.set_column(4, 4, 6.69)
        worksheet.set_row(8, 24.0)

        # Set column to text column width less than 1 character.
        worksheet.set_column(6, 6, 0.45)
